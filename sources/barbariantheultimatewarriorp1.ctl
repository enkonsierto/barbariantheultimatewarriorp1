...
N 46467 Graphics bytes are in #R26752 for Stage 1 and #R30112 for Stage 2.
  46467 #HTML(<span>Background 2 Attributes.</span></br><img src="../images/bg/bg2_attrs.png">)
@ 46614 label=bg_1_attr_data
  46614 #HTML(<span>Background 1 Attributes.</span></br><img src="../images/bg/bg1_attrs.png">)
